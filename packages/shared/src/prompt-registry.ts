...
export function versionForPrompt(definition: PromptRegistryDefinition): string {
...
const DEFAULT_AUTHOR = "buyer-codex-platform";
  ...
  [
    {
      ...
      changeNotes:
        "Initial pricing-panel prompt for fair value, likely accepted, opener, and walk-away outputs.",
      systemPrompt:
        "You are the buyer-codex pricing engine for Florida residential real estate. Return only strict JSON with numeric price values in whole dollars. Never include markdown, commentary, currency symbols, or explanation outside the JSON object.",
...
- Calibrate to Florida buyer-side negotiating posture, not seller-optimized pricing.`,
    },
    {
      ...
      activateByDefault: true,
      changeNotes:
        "Initial deterministic spec for comps ranking and explanation output.",
...
- Overall confidence as the average confidence across emitted signals.`,
    },
    {
      ...
      activateByDefault: true,
      changeNotes:
        "Initial deterministic spec for aggressive, balanced, and competitive offer scenarios.",
...
- Respect buyer max budget if provided.`,
    },
    {
      ...
      activateByDefault: true,
      changeNotes:
        "Initial deterministic spec for Florida ownership-cost ranges.",
...
Return low / mid / high monthly ranges, annual totals, upfront costs, assumptions, and buyer-safe disclaimers.`,
    },
    {
      ...
      activateByDefault: true,
      changeNotes:
        "Initial deterministic spec for document classification, fact extraction, and Florida risk rules.",
      prompt: `Analyze uploaded real-estate documents for buyer-codex.
...
High-severity findings must require broker review before buyer exposure.`,
    },
    {
      ...
      activateByDefault: true,
      changeNotes:
        "Initial deterministic spec for comparative property-case synthesis.",
