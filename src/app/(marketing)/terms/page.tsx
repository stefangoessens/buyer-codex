...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      description="The terms that govern your use of buyer-codex."
      updatedAt="April 12, 2026"
    >
      <h2 className="text-base font-semibold text-neutral-800">1. Service Overview</h2>
      <p>
        buyer-codex provides AI-assisted property analysis and, where applicable, connects you with licensed Florida buyer representation. Content is informational and not legal, tax, or financial advice.
      </p>
