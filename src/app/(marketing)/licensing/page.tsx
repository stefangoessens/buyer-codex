...
export default function LicensingPage() {
  return (
    ...
    >
      ...
      <p>
        buyer-codex operates as a Florida-focused buyer brokerage platform. Representation services are provided through licensed Florida real estate professionals.
      </p>
